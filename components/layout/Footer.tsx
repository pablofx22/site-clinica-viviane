      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-brand">
            <div className="footer-brand-name">Dra. Viviane Seguro</div>
            <div className="footer-brand-sub">Biomédica Esteta · CRBM 5 6680</div>
            <p className="footer-brand-desc">
              Procedimentos estéticos de alto padrão em Porto Alegre. Técnica
              avançada, cuidado humano e resultados que respeitam a identidade
              de cada paciente.
            </p>
        ...
        <div className="footer-bottom">
          <p className="footer-copy">
            © {year} Clínica Dra. Viviane Seguro. Todos os direitos reservados.
          </p>
          <p className="footer-legal">
            CRBM 5 6680 · Biomédica Esteta · Porto Alegre – RS
          </p>
        </div>
      </div>
    </footer>
